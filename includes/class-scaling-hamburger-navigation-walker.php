        ...
        if ($has_children) {
            $output .= '<span class="nav-link__dropdown-icon" aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 17 10" fill="none">
                    <path d="M1.5 1.5L8.5 8.5L15.5 1.5" stroke="currentColor" stroke-width="1.5"
